...
PATH = "C:\\Users\\georgeau\\Desktop\\Zuckerman_Lab\\PROOF_MAKER\\RUNS\\SW_TESTING1_dgsw_05\\n_9999"
...
TITLE = "{/:Bold Transporter: Substrate, Toxin, and Sodium Flows} \n {/*0.85 dmu-W = 2, dg-SW = 0.5, Na-binds-first = FALSE, Vary dMu-N} \n {/*0.85 alpha = 0, seed = 123456, n-steps = 1e4, n = 9999}"
