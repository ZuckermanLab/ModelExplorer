...
def graph_pathways(sub_weighted_edge_list, sub_image_file_name, sub_analysis_labels = {}):
    ...
    if 'proof=1' in analysis_labels[0]: #checks for proofreading.
        G.add_node("E",pos=(100,150))
        G.add_node("E-ATPb",pos=(50,75))
        G.add_node("E-ADPPIb",pos=(100,100))
        G.add_node("E-ATPb-Hb",pos=(150,125))
        G.add_node("E-ADPPIb-Hb",pos=(75,25))
        G.add_node("E-ATP-Hb-Hb",pos=(125,50))
        G.add_node("E-ATP-Hb-Hb",pos=(300,150))
        G.add_node("E-Hb",pos=(250,75))
        G.add_node("E-x",pos=(300,100))
    ...
    plt.xlim(l-30,r+30)
    plt.ylim(b-5,t+5)
    plt.suptitle("Relative) Flux Pathway",)
